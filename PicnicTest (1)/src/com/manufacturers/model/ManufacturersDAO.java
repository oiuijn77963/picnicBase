...
public class ManufacturersDAO implements ManufacturersDAO_interface {
	...
	private static final String DELETE = "UPDATE MANUFACTURERS SET MF_STA='R' WHERE MF_NO=?";
	...
	private static final String FINDALL = "SELECT * FROM MANUFACTURERS Where MF_STA != 'R'";
